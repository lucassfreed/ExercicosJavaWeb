...
public class AlunoEditar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
        ...
        AlunoBean aluno = new AlunoDAO().obterAlunoPorID(id);
        ...
        out.println("<input class='form-control' type='text' class='form-control' id='campo-nome' name='nome' required='required' onfocusout='validarNome()' value='" + aluno.getNome() +"'>");
        out.println("</div>");
        ...
        out.println("<input class='form-control' type='text' class='form-control' id='campo-nota1' name='nota_1' required='required' onfocusout='validarNota1()' value='" + aluno.getNota1() + "'>");
        out.println("</div>");
        ...
        out.println("<input class='form-control' type='text' class='form-control' id='campo-nota2' name='nota_2' required='required' onfocusout='validarNota2()' value='" + aluno.getNota2() + "'>");
        out.println("</div>");
        ...
        out.println("<input class='form-control' type='text' class='form-control' id='campo-nota3' name='nota_3' required='required' onfocusout='validarNota3()' value='" + aluno.getNota3() + "'>");
        out.println("</div>");
        out.println("<div id='div-campo-frequencia' class='form-group'>");
        out.println("<label for='campo-frequencia'>Frequência: </label>");
        out.println("<input class='form-control' type='text' class='form-control' id='campo-frequencia' name='frequencia' onfocusout='validarFrequencia()' value='" + aluno.getFrequencia()+ "'>");
        out.println("</div>");
